                 ...
                 <v-card
                    ...
                    >
                     ...
                     <v-list-item three-line style="width: 94%; padding-top: 20px"  >
                       ...
                       <div class="d-flex justify-content-center align-items-center py-5" v-if="isLoadingComments">
                                <v-progress-circular
                                  indeterminate
                                  color="grey"
                                ></v-progress-circular>
                          </div>
                       <div v-if="isLoadingComments === false &&  allComments.length === 0 "  class="no-result center-element  py-5">
                          <span>Aún no hay comentarios</span>
                       </div>
                     
                      <v-list class="content-comments" v-if="isLoadingComments === false && allComments.length > 0 " three-line>
...
export default {
  ...
  computed:{
     ...mapState("course", ["allComments","lesson", "course_active", "isLoadingComments"]),
