    ...
    <b-form @submit.prevent="singin">
      <div class="mt-5">
        <b-form-group class="my-2 subtitle text-white" label="Usuario *">
          <b-form-input class="rounded-pill mt-2" type="text" v-model="form.username" placeholder="Ingrese su usuario"
      ...
      <div class="mt-5">
        <b-form-group class="my-2 subtitle text-white" label="Contraseña *">
          <b-form-input class="rounded-pill holder-form mt-2" type="password" v-model="form.password"
      ...
      <b-form-group>
        <b-form-checkbox-group>
          <b-form-checkbox class="subtitle text-white mt-4" value="me"
            name="checkbox-validation">Recuerdame</b-form-checkbox>
        </b-form-checkbox-group>
      </b-form-group>

      <b-button class="submit-iniciar rounded-pill mb-5" type="submit" block>Ingresar</b-button>
        ...
        <v-card-text class="mt-6">
          <v-form ref="form3" v-model="valid3" lazy-validation>
            <div class="row">
              <div class="col">
                <p>
                  Enviaremos un correo con sus credenciales, ingrese su correo
            ...
            <div class="row">
              <div class="col">
                <v-text-field outlined v-model="form3.email" label="Correo" required typeof="email"
